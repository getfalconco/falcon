...
const kbdVariants = cva(
  "inline-flex items-center justify-center font-mono font-medium text-xs bg-muted text-muted-foreground border border-border rounded-md border-b-[3px] transition-all duration-75 cursor-pointer select-none active:translate-y-[1px] active:border-b-[1px] hover:bg-muted/80 shadow-sm",
  {
    variants: {
      variant: {
