          ...
          {Array.from({ length }, (_, i) => {
            ...
            return (
              <div
                ...
                data-filled={char !== ""}
                className={cn(
                  "relative grid h-12 w-9 place-items-center overflow-hidden border font-mono text-lg tabular-nums text-white transition-colors duration-200 sm:h-14 sm:w-10 sm:text-xl",
                  showSuccess
              ...
              >
                {isActive && !showSuccess ? (
                  <motion.span
                    ...
                    className={cn(
                      "pointer-events-none absolute top-1/2 h-6 w-px -translate-y-1/2 bg-white",
