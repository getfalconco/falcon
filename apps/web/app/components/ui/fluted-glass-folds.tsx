...
const UNIFORMS = {
  colors: [[0.403921568627451,0.9098039215686274,0.9764705882352941],[0.08235294117647059,0.3686274509803922,0.4588235294117647],[0.027450980392156862,0.10196078431372549,0.1411764705882353],[0.9411764705882353,0.9921568627450981,0.9803921568627451],[0.9411764705882353,0.9921568627450981,0.9803921568627451],[0.9411764705882353,0.9921568627450981,0.9803921568627451],[0.9411764705882353,0.9921568627450981,0.9803921568627451],[0.9411764705882353,0.9921568627450981,0.9803921568627451]] as [number, number, number][],
  colorCount: 4,
  scale: 1.920,
  intensity: 0.860,
  paramA: 0.320,
  ...
  cursorRadius: 0.460,
  oklab: 0.0,
  // Matches the desktop app's login panel (~6.25× the shader's shipped 1.316).
  timeScale: 8.225,
}
...
export function ShaderBackground({
  ...
  useEffect(() => {
    ...
    const paddedColors: number[] = []
    for (let i = 0; i < 8; i++) {
      const c = palette[i] ?? palette[palette.length - 1] ?? [1, 1, 1]
      paddedColors.push(c[0], c[1], c[2])
    }
    ...
    gl.uniform3fv(uni.colors, new Float32Array(paddedColors))
    gl.uniform4f(
      uni.shape,
      UNIFORMS.scale,
      UNIFORMS.intensity,
